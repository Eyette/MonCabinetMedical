                  ...
                  <div class="row">
                    <div class="col-md-4 col-sm-6">
                      <center><img src="<?php echo e(asset('img/patient-icon.png')); ?>" class="img-profile rounded-circle img-fluid"></center>
                       <h4 class="text-center"><b><?php echo e($patient->name); ?></b> <label class="badge badge-primary-soft"> <a href="<?php echo e(url('patient/edit/'.$patient->id)); ?>" ><i class="fa fa-pen"></i></a></label></h4>
                            <hr>
                    ...
                    <div class="col-md-8 col-sm-6">
                      ...
                      <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="prescriptions" role="tabpanel" aria-labelledby="prescriptions-tab">
                          <div class="row">
                            <div class="col">
                                <button type="button" class="btn btn-primary btn-sm my-4 float-right" data-toggle="modal" data-target="#NewDocumentModel"><i class="fa fa-pen"></i> <?php echo e(__('sentence.Write New Prescription')); ?></button>
                            </div>
                          </div>
                          <table class="table">
                            <tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Eyette\Documents\Mes projets\MonCabinetMedical\resources\views/patient/view.blade.php ENDPATH**/ ?>