                    ...
                    <div class="col-md-8 col-sm-6">
                      ...
                      @if(!auth()->user()->isPatient)
                        ...
                        <div class="tab-pane fade" id="prescriptions" role="tabpanel" aria-labelledby="prescriptions-tab">
                          <div class="row">
                            <div class="col">
                                <button type="button" class="btn btn-primary btn-sm my-4 float-right" data-toggle="modal" data-target="#NewDocumentModel"><i class="fa fa-pen"></i> {{ __('sentence.Write New Prescription') }}</button>
                            </div>
                          </div>
                          <table class="table">
                            <tr>
